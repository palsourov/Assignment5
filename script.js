...
//   card1
document
  .getElementById("completedButton1")
  .addEventListener("click", function (event) {
    event.preventDefault();
...
// card2
document
  .getElementById("completedButton2")
  .addEventListener("click", function (event) {
    alert("board upload successfully");
    number++;
...
// card3
document
  .getElementById("completedButton3")
  .addEventListener("click", function (event) {
    alert("board upload successfully");
...
// card4
document
  .getElementById("completedButton4")
  .addEventListener("click", function (event) {
    alert("board upload successfully");
    number++;
...
// card5
document
  .getElementById("completedButton5")
  .addEventListener("click", function (event) {
    alert("board upload successfully");
    number++;
    if (number == 6) {
...
const n = 0;
document
  .getElementById("completedButton6")
  .addEventListener("click", function (event) {
    alert("board upload successfully");
    number++;
    if (number == 6) {
